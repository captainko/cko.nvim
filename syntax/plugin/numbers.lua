...
local function is_ignored()
	return is_floating_win() or vim.tbl_contains(vim.g.number_buftype_ignored, vim.bo.buftype)
end

---Determines whether or not the current buffer has disabled relativenumber
---@return boolean
local function is_disabled()
	if vim.b.is_enabled == nil then
		return false
	end

	return not vim.b.is_enabled
end
...
commander.command("ToggleRelativeNumber", function()
	if vim.b.is_enabled == nil then
		vim.b.is_enabled = true
	end

	vim.b.is_enabled = not vim.b.is_enabled
	if vim.b.is_enabled then
...
commander.augroup("ToggleRelativeLineNumbers", {
	{
